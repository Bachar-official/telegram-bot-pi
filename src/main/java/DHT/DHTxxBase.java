...
public abstract class DHTxxBase implements DHTxx {
    ...
    protected int[] getRawData() throws Exception {
        /*
         * Store the count that each DHT bit pulse is low and high. Make sure array is
         * initialized to start at zero.
         */
        ...
        /*
         * Need a very short delay before reading pins or else value is sometimes still
         * low.
         */
        /*
         * for (int i = 0; i < 50; ++i) {}
